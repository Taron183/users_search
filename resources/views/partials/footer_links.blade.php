...
{{--<script src="{{ asset('bower_components/ckeditor/plugins/uploadfile/plugin.js')}}"></script>--}}
{{--<script src="{{ asset('bower_components/ckeditor/plugins/uploadimage/plugin.js')}}"></script>--}}
